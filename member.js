function member() {
    this.setContent = function (event, list) {
    ...
    this.setMemberCount = function (event, list, work) {
        ...
        data.get().then(querySnapshot => {
            ...
            for (var i = 0; i < work.length; i++) {
                ...
                var percent = workTotal > 0 ? Math.round(workTotal / total * 10000) / 100.00 + "%" : "0%";
                newAllStr.push({
                    "type": "box",
                    "layout": "vertical",
                    "margin": "lg",
